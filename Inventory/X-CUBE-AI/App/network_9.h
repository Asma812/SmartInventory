...
#ifndef AI_NETWORK_9_H
#define AI_NETWORK_9_H
#pragma once
...
/******************************************************************************/
#define AI_NETWORK_9_MODEL_NAME          "network_9"
#define AI_NETWORK_9_ORIGIN_MODEL_NAME   "keras_model"

/******************************************************************************/
#define AI_NETWORK_9_ACTIVATIONS_ALIGNMENT   (4)
#define AI_NETWORK_9_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK_9_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_NETWORK_9_IN_NUM        (1)

AI_DEPRECATED
#define AI_NETWORK_9_IN \
  ai_network_9_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_9_IN_SIZE { \
  AI_NETWORK_9_IN_1_SIZE, \
}
#define AI_NETWORK_9_IN_SIZE_BYTES { \
  AI_NETWORK_9_IN_1_SIZE_BYTES, \
}
#define AI_NETWORK_9_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_9_IN_1_HEIGHT      (224)
#define AI_NETWORK_9_IN_1_WIDTH       (224)
#define AI_NETWORK_9_IN_1_CHANNEL     (3)
#define AI_NETWORK_9_IN_1_SIZE        (224 * 224 * 3)
#define AI_NETWORK_9_IN_1_SIZE_BYTES  (602112)

/******************************************************************************/
#define AI_NETWORK_9_OUT_NUM       (1)

AI_DEPRECATED
#define AI_NETWORK_9_OUT \
  ai_network_9_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_NETWORK_9_OUT_SIZE { \
  AI_NETWORK_9_OUT_1_SIZE, \
}
#define AI_NETWORK_9_OUT_SIZE_BYTES { \
  AI_NETWORK_9_OUT_1_SIZE_BYTES, \
}
#define AI_NETWORK_9_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK_9_OUT_1_HEIGHT      (1)
#define AI_NETWORK_9_OUT_1_WIDTH       (1)
#define AI_NETWORK_9_OUT_1_CHANNEL     (30)
#define AI_NETWORK_9_OUT_1_SIZE        (1 * 1 * 30)
#define AI_NETWORK_9_OUT_1_SIZE_BYTES  (120)

/******************************************************************************/
#define AI_NETWORK_9_N_NODES (102)
 ...
 * @ref ai_network_9_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_9_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_9_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network_9_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_NETWORK_9_*
 * defines into file @ref network_9.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_9_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_NETWORK_9_H */
